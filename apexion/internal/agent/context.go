...
// loadProjectContext scans for APEXION.md / .apexion/context.md files and returns
...
func candidatePaths(cwd, gitRoot string) []string {
	...
	if home, err := os.UserHomeDir(); err == nil {
		add(filepath.Join(home, ".config", "apexion", "context.md"))
		add(filepath.Join(home, ".config", "apexion", "APEXION.md"))
	}
