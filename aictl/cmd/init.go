...
func newInitCmd() *cobra.Command {
	return &cobra.Command{
		...
		Long:  "Guides you through setting up aictl: choose a provider, enter your API key, and save the config.",
...
func runInit() error {
	...
	fmt.Println("Welcome to aictl configuration wizard!")
	fmt.Println()
	...
	configDir := filepath.Join(home, ".config", "aictl")
	...
	fmt.Printf("\nConfig saved to %s\n", configPath)
	fmt.Println("You can now run: aictl")
	return nil
}
